...
namespace _04___TheBigBark_WebUI.Controllers
{
    ...
    {
        private TheBigBarkDATABASEEntities db = new TheBigBarkDATABASEEntities();

        // GET: Appointments1
        public ActionResult Index()
        {
            var appointments = db.Appointments.Include(a => a.AspNetUser);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,Date")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
